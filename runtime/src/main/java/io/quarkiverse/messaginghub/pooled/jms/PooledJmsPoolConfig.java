...
public interface PooledJmsPoolConfig {
    ...
    /**
     * By default a Session that has been loaned out on a call to createProducer will use a single anonymous JMS MessageProducer
